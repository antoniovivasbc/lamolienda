...
function init() {
  ...
  var slide = new Slide(width, height, 'out');
	...
	l1.load('https://antoniovivasbc.github.io/lamolienda/img/bg-1.png', function(img) {
	  slide.setImage(img);
	})
  ...
  var l2 = new THREE.ImageLoader();
	...
	l2.load('https://antoniovivasbc.github.io/lamolienda/img/bg-2.png', function(img) {
		slide2.setImage(img);
	})
